...
class CrugeUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('state, totalsessioncounter, currentsessioncounter, id_persona', 'numerical', 'integerOnly'=>true),
			...
			array('iduser, regdate, actdate, logondate, username, email, password, authkey, state, totalsessioncounter, currentsessioncounter, id_persona', 'safe', 'on'=>'search'),
		);
	}
	...
	public static function model($className=__CLASS__)
	{
       ...
       public static function BuscarPersona($idPersona){
       $consulta = self::model()->findByAttributes(array('iduser'=>$idPersona));
